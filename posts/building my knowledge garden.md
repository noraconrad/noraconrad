...
- [x] Create new public Obsidian vault (separate from my private notes)
...
- [x] Create `/About` page (portfolio of projects, origin story, why I shifted)
...
- [x] Test all links work (internal and external)
