...
If you’ve been following me for a while, you know I’m passionate about systems — not just tools. In my [blog post series](http://www.noraconrad.com/s/tag/core-5/img), I talk about how you need five core apps:
...
**_And, yes, this post is sponsored by_** [**_Sunsama_**](https://try.sunsama.com/ohcodu7jipuk)**_. I partner with their team often because I love their system and I’ve used this tool for years. I don’t do sponsored posts unless I actively use the tool I’m promoting._**

<figure>

![](images/1*HytjThXi0fVGFMKYwC7hBw.jpeg)
...
3. You create a task in your task manager

5. You check your calendar to see when you might have time

7. You go back to email to respond with a timeline

9. Later, you have to search your emails to find the context for the task

11. You have to track time to invoice later in yet another tool
...
3. **Calendar integration:** See your meetings alongside available work blocks

5. **Task curation:** Choose which tasks make sense for today, tomorrow and next week (not an endless backlog)

7. **Time estimation:** Add time estimates to be realistic about your day

9. **Categorization**: Add channels to see where you spend most of your time

11. **Prioritization:** Drag and drop tasks into your actual timeline
...
3. Drag emails from Gmail/Outlook into Sunsama as tasks

5. Maintain the email as context within the task (even if you archive it in your email system)

7. Schedule the task into your actual day

9. Choose how the email is managed once the task is complete (archive, label, etc)
...
3. Statistics on how your week went (tasks completed, focus time, etc.)

5. Easy rolling over of incomplete tasks to the next week

7. Analysis of your workload and capacity
...
3. **Make my calendar more realistic:** My Google Calendar now accurately reflects what I’m actually working on, not just meetings

5. **Process email faster:** My inbox consistently stays at zero because emails immediately become tasks or get archived

7. **Reduce context switching:** I spend less time jumping between apps and more time in focused or pomodoro mode
...
3. **Tasks:** Sunsama becomes your daily task hub

5. **Notes:** Still need a separate tool (I use Notion)

7. **Calendar:** Sunsama integrates with your existing calendar(s)

9. **Passwords:** Still need a dedicated manager
...
Or check out my [Getting Started in Sunsama video](https://www.youtube.com/watch?v=RYYk5ZM_-Zw&t=71s) that walks you through the full sign up process.
...
- **Project management:** Asana, Todoist, Trello, Jira, ClickUp, [Monday.com](http://Monday.com)
...
3. **Personal reflection:** I add a quick note about how the day felt, challenges I faced, or insights I gained

5. **Sharing options:** Depending on the day, I might:  
...
7. **Pattern recognition:** Over time, I’ve noticed trends in my productivity that have helped me restructure my ideal week
...
3. **Connect your work tools** (many of which you may already have integrated)

5. **Customize your preferences** for what gets included in your highlights

7. **Choose your sharing preferences** (private, email, Slack, Teams)
...
The best productivity tool is the one you’ll actually use consistently. For me, [Sunsama](https://try.sunsama.com/ohcodu7jipuk) has become that tool because it bridges the gaps between my calendar reality and my task intentions.
