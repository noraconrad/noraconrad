...
![](images/1*3MndhyZBVBF75xK5nciuuw.png)

### 01\. CORE BUSINESS

When we first start a blog or a business, either we tend to have no ideas or five-thousand. Either way, working through what your focus is for your business will help you focus on the things you want to spend your time on. Think of this part as your elevator pitch — when someone asks “what do you do”, what is your answer?
...
_I help women get organized and simplify their lives so that they have more time to grow a business, a family, or their faith. I do this through blog posts, videos and courses so that however they prefer to learn, they can get all the tools they need to start getting margins in their day._

Your pitch doesn’t need to belong or be complicated. Start with some simple questions first to get to the bottom of what your business is about.
...
I’m all for free tools and using what you can to save money, but if you’re using 18 different free tools to manage your social media accounts, consider how much time it would save to invest in a tool like Buffer or [CoSchedule](https://coschedule.com/r/o789469) — the price doesn’t seem too bad when you compare how many hours you waste. Your time is valuable. Doing this might take some time. Switching to new tools can be time-consuming and cumbersome, but once you find that sweet spot, you’ll never need to switch again.
...
- [Squarespace](https://www.squarespace.com/) ($144/yr) — for my website and email newsletters
- [Google Suite](https://gsuite.google.com/) ($6/mo) — for my domains, email, file storage, and calendars
- [Podia](https://app.podia.com/) ($32/mo) — for my courses and shop
- [Tube Buddy](https://www.tubebuddy.com/noraconrad) ($39 one time) — tools and resources for my youtube channel
- [Linktree](https://linktr.ee/) (free) — for linking to multiple resources from my Instagram account
- [Quickbooks](http://fbuy.me/nb_RR) (free with my turbo tax) — for bookkeeping and tax purposes
- [TurboTax Small Business](https://turbo.intuit.com/) ($106) — for my yearly taxes
- [Canva](https://www.canva.com/) (free) — to create graphics for my YouTube channel and site
- [Milanote](https://milanote.com/) (free) — for making quick notes and brainstorming
- [Capital One](https://capital.one/2DkNiaQ) (free) — for my online business banking, check, and savings accounts
...
For updated resources and tools I use — check out my resource page [here](http://www.noraconrad.com/s/librarylibrary?format=original).

The only social media account I actively use and post to is Instagram. Technically YouTube, but I view that more like a blog than a social media account. There are two things I could combine here to simplify my site even further; I could host my own courses and shop on Squarespace and get rid of Podia altogether. I might do this in the future — but for now, I love the freedom and flexibility Podia gives me when it comes to designing and selling my products. The money is worth it to me because I save myself and my customers time from working on a platform that isn’t meant to host a course.
...
This portion might be the hardest and most time-consuming of all the steps. Every business has a different purpose and different goals for its audience, so it’s tough to give examples here, but I hope you can use some of the methods I’ve used to simplify my business to do the same to yours.
...
Take some time to make a map of your site, offerings, and products. Then cut out what you don’t need and combine what you can. I used [Miro](https://miro.com/) to do mine, but you can use a pen & paper too or a tool like [Milanote](https://milanote.com/).

![](images/1*ZjTFYvLqz9YELD36l1KOxw.png)

BEFORE SIMPLIFYING

![](images/1*RqHbPtVTH6-JKJ6iKNI6Mg.png)

AFTER SIMPLIFYING

Even though I cut back A LOT on my site and business, I actually make more money now than I did with the previous setup. When you can focus on more important aspects and cut out the clutter, every piece of content becomes more valuable, and you’ll be able to make more of an impact.
