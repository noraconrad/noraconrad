...
**_Here are all the things that live in my Notion account:_**
...
I have free Notion templates for a lot of the things I use if you want to check any of those out [HERE](https://bit.ly/NoraNotion). Notion is essentially always open on my desktop and one of the only apps on my phone’s home screen. Anytime I’m making a grocery list, brain dumping a quick list, or taking notes, Notion is the app I use.

### 🗓 Google Calendar

As for my event management, Google Calendar is my absolute favorite calendar app. My husband and I both use it so it makes it super easy to share events. We also use [Google Pixel and Fi](https://g.co/fi/r/VPU3PV) for our phones, so the ease of use within the Google suite is super smooth.
