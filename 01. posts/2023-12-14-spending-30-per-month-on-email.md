...
Superhuman is a super fast email client that allows you to connect Gmail and Outlook emails into their platform. It claims to save you hours a month on emails and is loved by many big creators; [Ali Abdaal](https://medium.com/u/b6cdcdab26dd), [Francesco D'Alessio](https://medium.com/u/c58823d6744), and [Tiago Forte](https://medium.com/u/7b122207920c) — the list goes on.

![](images/1*b2ObsV1_z_dxr59DSvdpLg.gif)
...
1. Gmail (combined all into one account)— the best option so far, but it is not very pretty, and I easily get distracted because of the plugins and apps I use. It's also overwhelming to look at when I’m not at inbox zero.
2. Spark Mail — It was fine, but it was really slow on my phone and often didn’t sync well with one account in particular. I felt like there were too many features I was settling for and not loving.
3. Canary Mail — I can’t get past some of the bugs I was experiencing. From all my font colors being stuck to white to emails I deleted weeks ago magically reappearing, it was annoying. I liked the app quite a bit, but nothing incredible keeps me hooked enough to deal with some of the weird issues.
...
I recently [shared the list of nearly $1,700 subscriptions I pay for every year](https://medium.com/@noraconrad/apps-and-tools-im-paying-for-in-2024-83bc65132543), and upon reflection, email is one of the places I spend most of my time. I figured I could sacrifice one of my many subscriptions if Superhuman worked as well as I hoped it would.

* * *

### What could possibly justify this price tag?

Every video I’ve seen about Superhuman seemed ~_vague_~ on what made this platform so special. I knew it was fast and focused on using keyboard shortcuts, but is that it?
...
**_Quick shameless plug for_** [**_my affiliate link_**](https://superhuman.com/refer/39m696dh): if you want to try a free month, you also give me a free month**_. Thanks ;)_**
...
![](images/1*9kUA_XbGUwpE4eeM6CSQUw.png)
...
![](images/1*7Qo3zlnTqA-4CcmwqNA_1Q.png)
...
The contact pane includes data from [Clearbit](https://clearbit.com/), giving you a look at the person based on public social media details and links to the five most recent emails for easy reference.
...
![](images/1*Knp_QN2Io-eLIf6d2sIUwg.png)

Superhuman’s sorting is really _really_ **really** good. It also offers better default category options like Google Docs, Notion, or Asana emails, so you can find emails faster and make time for specific focuses during the day. You can easily add new splits by hitting the Cmd+K or Ctrl+K, then New Split Inbox. From here, you can create the new split based on the email address, domain, recipient, or subject. You can create a new name, and now a new split is added.

![](images/1*_fVxUAtri4SZSwfM6jGfog.png)

If you like Gmail’s existing categories and rely on them, you can [create splits based on the Gmail categories](https://help.superhuman.com/article/441-splits).

#### Snippets (aka templates)

This might be a winning feature if you find yourself writing the same kind of emails repeatedly. Unlike Gmail’s clunky and often buggy templates, Superhuman’s snippets feature is well thought out. From variables like {first\_name} or even {your\_placeholder}, to the ease of inserting and using these, Superhuman stands out among the crowd.

![](images/1*AFr1v2z6b-GQPRjWDSXK4g.png)
