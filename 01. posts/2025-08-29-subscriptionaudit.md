...
![](images/App+Subscriptions+Audit+Aug+2025.webp)
...
This is my Swiss Army knife subscription. For $13.50/month, I get access to 240+ Mac apps including CleanMyMac, Cleanshot, Bartender, and now Spark Mail (which replaced my $30/month Superhuman subscription). The [math still works](https://blog.noraconrad.com/setapp-is-it-worth-a-subscription-70b53033ae5c), just 2–3 apps I regularly use would cost more individually.
...
I love Superhuman. I wrote a [blog post](https://blog.noraconrad.com/spending-30-per-month-on-email-51bb1f5c41ca) about it awhile back — and while I have tried to find something else to triage my inboxes, I always come back. I have **9! different email** accounts (most of them are based on client contracts). Superhuman is the easiest way to quickly pour through those.
