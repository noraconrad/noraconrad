...
![](1*1YHt8YqnhXJdWOZx3t3jJA.png)

**_(btw, this post is not sponsored; I’m just a huge fan. I do have some invite links available if you want one, just leave a comment)_**
...
1. **Clipboard history** for all those times you needed something you copied and accidentally hit CTRL C instead of V
2. **Calculator**: I use this 10x a day minimum
3. **Timezone converter:** I use this constantly when booking client meetings
4. **Floating Notes** is the perfect pop-up sticky note for jotting down thoughts or notes to sort out later. I use this all the time during phone calls or short meetings that don’t require a full meeting note in Notion
5. **Window Management** makes sorting my windows on my ultra-wide a breeze. It’s super easy to split my views, move apps, or organize my work with two clicks.
6. **The calendar** extension connected to Notion Calendar is incredible. I can quickly view upcoming events, get notifications or reminders even when my calendar app is closed, and add events in a few clicks.
7. **Apple Shortcuts** can be run from Raycast in just a click. I have all my Notion habits linked to my Apple shortcuts to work with my NFC tags, but if I want to log a habit quickly, I can do it with Raycast in a second.
...
I recently shared Raycast in my [list of apps I’m paying for this year](https://medium.com/@noraconrad/apps-and-tools-im-paying-for-in-2024-83bc65132543), and it’s because of how much the app has grown on me over the past two years. I use it multiple times a day, every day, and I think it can also be a super valuable tool in your workflow.

Grab [Raycast](https://www.raycast.com/) here.

---

**_What apps do you consider “essential” to your workflow? I’d love to check out some new apps for myself!_**

By [Steph Nora Conrad](https://medium.com/@noraconrad) on [February 12, 2024](https://medium.com/p/0dcd7e67a77f).

[Canonical link](https://medium.com/@noraconrad/this-might-be-the-best-mac-app-you-didnt-know-you-needed-0dcd7e67a77f)
