---
coverImage: 1*mjnaJSgyQeHGkHbyuo8iXw.png
---
...
Planning out our meals in advance not only saves us hundreds of dollars every month, but it helps us eat better and really enjoy dinner. Too many people don’t eat dinner with their families anymore. When my husband and I got married, we decided we might not make a four-course meal every night but even over pizza, dinner time would be a time to catch up with each other and spend quality time together.

We plan our meals one month in advance. I have an entire blog post and video about it if you want to learn more.

### 02. PLAN YOUR OUTFIT THE NIGHT BEFORE

A couple of years ago, if you had opened my closet, you would’ve been assaulted by clothes, hangers, and accessories. Last year I decided to cut my closet down to 100 items or less, and since then, I’ve realized how much stress and anxiety my clothes were actually producing in my life.
...
[Marie Kondo’s book](http://amzn.to/2CUpvdJ) inspired me to live with fewer clothes, so if you haven’t jumped on this book craze yet, it’s time. You can pick up a used copy for less than $5 [here](http://amzn.to/2CUpvdJ).
...
You might not know this, but I actually have a course all about getting you to Inbox zero! You can sign up [RIGHT HERE](https://shop.noraconrad.com/the-conrad-hub). I’ve already had hundreds of people go through the course and clean up their inboxes once and for all.

If you don’t want to take a course for this, just do it little by little! Unsubscribe from newsletters rather than just deleting them. Set up folders and tags, start to automate them.
...
Don’t have time for breakfast — Starbucks. Don’t have time to clean — hire a maid. Don’t have time to bake cookies for the school bake sale — the grocery store. Outsourcing doesn’t always mean hiring a full-time assistant to do your errands. You can outsource simple chores. We started ordering our groceries online to save us a trip each week. There are a ton of little things you can do like this to free up a couple of minutes each day.

Ask yourself what you dread doing and see if there’s a service that can do it for you. Check out [TaskRabbit](https://www.taskrabbit.com/), [Uber](https://www.uber.com/invite/stephaniec18349ue), [Instacart](https://www.instacart.com/), [HelloFresh](https://www.hellofresh.com/?c=STEPCONRA&utm_source=raf-share&utm_medium=referral&utm_campaign=clipboard), and [Task Army](https://taskarmy.com/) for some inspiration.
...
If you feel like every single day is packed to the brim, tracking your time might help you get some insight int what your time wasters are. I tracked my time for a full month to see where I was wasting the most time and the results really helped me better understand my habits.
...
- Sign up for the [national do not call registry](https://www.donotcall.gov/) to limit the spam phone calls.
- Limit the amount of junk mail you receive by adding your info [here](https://dmachoice.thedma.org/), [here,](https://www.optoutprescreen.com/?rf=t) and [here](https://www.valpak.com/coupons/show/mailinglistsuppression).
...
- Take a weekend to scan old family photos to [Google Photos](https://photos.google.com/). Either store or recycle the photos when you're done.
