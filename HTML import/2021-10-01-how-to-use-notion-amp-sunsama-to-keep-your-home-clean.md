...
date: '2021-10-01'
coverImage: 0*6UJuLlSMoXNTx0WL.png
...
_As I said, I have two lists: Maintenance and Cleaning:_

[DOWNLOAD THE TEMPLATES](https://shop.noraconrad.com/notion-templates-by-nora)
...
As much as I love Notion, it does fall short as a task manager for me. [Sunsama](https://get.sunsama.com/nora) (affiliate link) has become my one and only task manager, project planner, and day scheduler in recent months. Sunsama definitely isn’t for everyone, and I do have a review [HERE](https://www.youtube.com/watch?v=fHKVanEVvQ8) if you’re curious, but for me, it’s made scheduling these tasks a breeze.

![](1*ccMe81re7GssWrt8Xgt-UA.png)

Here’s a quick step-by-step look at how I add my reoccurring tasks to my Sunsama schedule:

1. Add a new task that you need to complete (I just copy and paste this directly from my notion template)
2. I assign this task to my channel called “home” so that I can categorize and sort these tasks later on.
3. I add any subtasks that may be needed to complete the task and add estimated time to complete each task
4. Add a “due date” of when the task needs to be completed next
5. Choose to “repeat” the task if needed (currently, the furthest out you can choose in Sunsama is every 4 months, so for seasonal tasks, I just duplicate the task as needed)
6. Add any additional notes, links or info needed to complete the task
7. Add this task to your backlog or set a start date the week before the task is due to remind yourself to properly schedule it in the future.

### 🔨 ADAPT IT TO FIT YOUR SYSTEMS
