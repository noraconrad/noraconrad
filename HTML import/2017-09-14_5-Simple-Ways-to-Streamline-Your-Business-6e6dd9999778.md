...
When you start your own business, you put on a ton of hats — accountant, administrative assistant, office manager, sales team, creative…
...
![](1*VjnYEfiGlAi5S2ZXnaY0DA.png)

### 02. ADD SOME ROBOTS TO YOUR TEAM
...
If This Then That was one of the first tools that allowed me to automate some tasks. The first thing I did, was set my Instagram posts to automatically share on Twitter as native images. There are a million things you can do with this tool. [Check out what applets you can make here.](https://ifttt.com/discover)

#### Zapier

This tool is free for up to 100 uses per month, so I only use this, for one thing, sending my blog comments to ToDoist. Anytime someone posts a new comment on my site, I get a task added to my day that reminds me to respond. This way I don’t ever miss your comments and I can give answers quickly. Of course, there are a ton of other zaps as well. [Check out what you can do on Zapier.](https://zapier.com/app/dashboard)

#### Integromat

This is a newer tool I discovered, but I use this one to move all my Asana tasks into ToDoist for me. There are a ton of options on this site as well, so sign up and give it a look. [Get started with integromat now.](https://www.integromat.com/)
...
CoSchedule is my favorite app of all time. I’ve talked about this one a lot because it’s how I manage all of my content in one place and keep myself from forgetting important posts. If you want to use [my affiliate link for Coschedule](http://coschedule.com/r/21260) you’ll help me get a little discount on their services (thanks!)

#### Tailwind

There’s been a lot of buzz about tailwind lately, and for good reason! It’s the easiest tool out there for scheduling Pinterest pins. Tailwind is a great value if you can pay for the yearly plan upfront. Every weekend I go through all the blogs I follow (using Feedly) and I save their posts to tailwind to schedule for the rest of the week. This gives me the chance to really read what I’m sharing, learn new things, and create my social media for the next week. [You can use my affiliate link to get a month free](https://www.tailwindapp.com/i/NoraConradCom).

#### Grum

This tool is less known, but it’s one of my favorites. This is how I schedule all my Instagram posts for the month. Grum posts to Instagram directly, uses the first comment for hashtags, and still abides by all of Insta’s crazy rules and terms. It’s one of the few companies that actually do this, and it is worth it. You can [check out Grum here](https://www.grum.co/), and if you want to use my promo code, “NoraConradFREEMONTH” you’ll get one month free to decide if you like it or not.

### 04. PLAN AHEAD & BATCH PROCESS
